import { AppBar, Button, FormControlLabel, IconButton, MenuItem, Radio, RadioGroup, Select, Switch, TextField, Toolbar, Typography } from '@material-ui/core';
    ...
    <>
      ...
      <Toolbar>
        ...
        <div className={`${styles.HeaderIcons} ${styles.Spacing}`}>
          ...
          <Button size="large" variant="contained">SECONDARY OPTION</Button>
          <Button size="large" variant="contained" color="primary" className={styles.Green}>SAVE</Button>
        </div>
      </Toolbar>
      </AppBar>
  ...
  return (
    <LocalizationProvider dateAdapter={DateFnsUtils}>
      ...
      <BcGroup id="generalInformation" title="General information" expanded={expanded} setExpanded={setExpanded}>
          ...
          <BcInputWrapper id="cernID" label="CERN ID" help={<iframe title="YouTube" style={{margin: '1rem auto'}} width="560" height="315" src="https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?autoplay=1&controls=0" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>}>
            <TextField />
          </BcInputWrapper>
        ...
        <BcGroup id="leaveInformation" title="Leave information" expanded={expanded} setExpanded={setExpanded}>
          ...
          <BcInputWrapper fullWidth id="contactPerson" label="Contact Person" help={<HelpMe helpText="Contact person help" />}>
            <TextField />
          </BcInputWrapper>
